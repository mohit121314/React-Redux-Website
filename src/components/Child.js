      ...
      <Wrapper>
        ...
        <Table>
          ...
          {featured_child &&
            ...
            featured_child.child_profile.map((item, index) => {
              return (
                <Tablerow>
                  <Tabledata>{item.name}</Tabledata>
                  <Tabledata>{item.sex}</Tabledata>
                  <Tabledata>{item.dob}</Tabledata>
                  <Tabledata>{item.father_name}</Tabledata>
                  <Tabledata>{item.mother_name}</Tabledata>
                  <Tabledata>{item.district_id}</Tabledata>
                  <Tabledata>
                    <NavLink
                      style={{
                        textDecoration: "none",
